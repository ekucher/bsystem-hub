...
BSYSTEM-HUB is the single entry point for BSYSTEM users. It provides authentication hand-off, application navigation, dashboard aggregation, global search, notifications, profile management, RBAC-aware UI, and deep links into connected modules.
...
- Single Sign-On through authentik (OIDC).
